...
if (puan === 4) {
  ...
  setTimeout(() => {
    ...
    gif.innerHTML = `<div style="width:480px"><iframe allow="fullscreen" frameBorder="0" height="270" src="https://giphy.com/embed/gfrz4h08N0MtBTUFGo/video" width="480"></iframe></div>`;
    video.append(gif);
  }, 1000);
  setTimeout(() => (video.innerHTML = ""), 5);
}
